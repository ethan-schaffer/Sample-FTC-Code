 ...
 * data to help tune the com.qualcomm.ftcrobotcontroller.navx_ftc library's AHRS class to retrieve
...
public class navXPerformanceMonitor implements IDataArrivalSubscriber {
     ...
     * delivering data samples to the com.qualcomm.ftcrobotcontroller.navx_ftc library IO thread.
