...
public class _BlueIsEthanAGod extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.initializeWithBotton(_BlueIsEthanAGod.this, hardwareMap, telemetry, true);
//        robot.initialize(_BlueIsEthanAGod.this, hardwareMap, telemetry, true);
