...
@Autonomous(group = "Defend", name = "Red_Defend")
public class New_DefendR extends LinearOpMode {
    ...
    double angTarg = 0;
        ...
        public void runOpMode() throws InterruptedException {
            robot.initialize(New_DefendR.this, hardwareMap, telemetry, true);
            angTarg = 10;
        ...
        robot.Move(100, 1);
        double timeD = getRuntime()-stTime;
        telemetry.clear();
        telemetry.addData("Time", timeD);
        telemetry.update();
