 ...
 */
@TeleOp(name="Who Needs an Operator?", group="TeleOpOld")
@Disabled
public class TeleOpFinalSingle extends OpMode {
    ...
    public void loop() {
        ...
        */
        ...
        RECENT_LB = gamepad1.left_bumper;
        RECENT_RB = gamepad1.right_bumper;
        /*
          _        __              _
         (_)      / _|            | |
          _ _ __ | |_ ___  ___  __| |
        ...
        */
        ...
        RECENT_X_BUTTON = gamepad1.x;

        if(RECENT_B_BUTTON && !gamepad1.b){
